...
class OptionsDialog(QDialog):
    ...
    def _populate_prizes_tab(self):
        ...
        prize_options_group = QGroupBox("Main Giveaway Prizes")
        ...
        self.prize_options_list_widget.setToolTip("List of prize options for main giveaway. Select to edit or remove.")
