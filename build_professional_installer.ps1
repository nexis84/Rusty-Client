...
# Pick the most recently written installer (avoid stale older files being selected)
$installerFile = Get-ChildItem -Path "installer_output" -Filter "RustyBot_Setup_*.exe" | Sort-Object LastWriteTime -Descending | Select-Object -First 1
