...
class GiveawayApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Rusty Bot v1.4.9 - Auto-Update REALLY Working Now!")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Clean up any temporary encrypted environment files
        try:
            from secure_env_loader import cleanup_environment
            cleanup_environment()
            print("🧹 Environment cleanup completed")
        except (ImportError, Exception) as e:
            print(f"Note: Environment cleanup skipped ({e})")
