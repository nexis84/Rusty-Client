...
Version 1.32+ - Updated for Main 2.py with latest improvements
"""
...
MAIN_SCRIPT = 'Main 2.py'
APP_NAME = "RustyBotGiveaway"
APP_VERSION = "1.32+"  # Updated version for latest improvements
...
# 2. Collect all files from the 'Fonts' directory recursively
datas_list.extend(collect_data_files('Fonts', 'Fonts'))

# 3. Add individual files that go in the root of the bundle
files_to_include = [
    'qwebchannel.js',
    'script.js',
    'style.css',
    ...
    'Loading.png',
    'RUSTY BOT.png',
    'Shentox-SemiBold.ttf',
    'triglavian-complete.otf',
    'portrait_test.html',  # Include the test file we created
]
